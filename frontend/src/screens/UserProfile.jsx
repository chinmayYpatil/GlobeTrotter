        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{safeTrips.length}</p>
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{upcomingTrips.length}</p>
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-600">{completedTrips.length}</p>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentTrips.map(trip => (
              <div key={trip.id || trip._id || Math.random()} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 cursor-pointer hover:shadow-xl transition-shadow" onClick={() => navigate(`/trip/${trip.id || trip._id}/view`)}>
                <div className="h-40 bg-gradient-to-r from-orange-400 to-red-400 relative overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="bg-orange-100 text-orange-800 text-xs px-2 py-1 rounded-full font-medium">Ongoing</span>
                  </div>
                ...
                <div className="p-4">
                  <div className="text-gray-600 mb-3 line-clamp-2 text-sm">{trip.description || 'No description.'}</div>
